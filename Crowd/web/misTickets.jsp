<%-- 
    Document   : misTickets
    Created on : 18/03/2019, 09:45:55 PM
    Author     : benja
--%>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="file-field input-field">
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text"  name="folio" placeholder="Busque su ticket con el numero de folio" onkeypress="soloNumeros()">
      </div>
    </div>
  </form>
           </div>
                    <!--<div id="encaps4">
                        ...
                        <div class="file-field input-field">
                        <input type="search" name="folio" placeholder="Busque su ticket con el numero de folio" onkeypress="soloNumeros()"/>
                        <input type="submit" name="busca" value="Buscar"/>
                            </div>
                    </form>
                        </div>-->
                    <%
                    String criterio = request.getParameter("folio") == null? "": request.getParameter("folio");
                    iTicketsDao ti = new impTicketsDao();
                    ArrayList<String> lista = new ArrayList<String>();
                   lista = ti.consultaUsuario(user.getBoleta(), criterio);
                   ...
                   if(lista.size()!= 0){
                       for (int i = 0; i < lista.size(); i++) {
                               out.println("<div id='opcsTXT'>"
                                       ...
                                       + "<div class='opc'>"
                                       + "<form method='post' action='consultaTicket.jsp'><input type='submit' name='folio' id='ticks' value='"+lista.get(i)+"'/></form>"
                                       + "</div>"
                                               + "</div>"
                                               + "</div>");
                           }
